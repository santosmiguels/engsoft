                ...
                <!-- Brand and toggle get grouped for better mobile display -->
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav main-nav  clear navbar-right ">
                            ...
                            <li><a class="color_animation" href="#reservation">Lanchonetes Cadastradas</a></li>
        ...
        <div id="top" class="starter_container bg">
            <div class="follow_container">
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <h4 class="white second-title">Encontre o melhor lanche para o seu melhor momento!</h4>
                    <hr>
                </div>
            </div>
        </div>
       ...
       <!-- ============ Our Bread  ============= -->
        ...
        <section id="bread" class=" description_content">
            <div  class="bread background_content">
                <h1 class="shadow"><span>Variedades!</span> Desde o café da manhã até a hora do jantar.</h1>
            </div>
            <div class="text-content container">
                <div class="col-md-6">
                    <h1>Um bom lanches para todas as horas</h1>
                    <div class="icon-bread fa-2x"></div>
                    <p class="desc-text">Várias lanchonetes abertas, desde cedo até o final da noite, para atender a todos com muitas ofertas.</p>
                </div>
                <div class="col-md-6">
        ...
        <section  id="reservation"  class="description_content">
            <div class="featured background_content">
                <h1 class="shadow">Lanchonetes Cadastradas</h1>
            </div>
            <div class="text-content container">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-xs-12">
                                        ...
                                        <div class="right-text">
                                            <h3>Lanchonetes Cadastradas</h3><hr>
                                            <?PHP
                                                    include ("/arqhtml/conexao.php");
                                                    $sqlconsulta = "SELECT * from empresas order by eCNPJ asc";
                                                    $consulta = mysqli_query($conn, $sqlconsulta) ;
                                                    if($consulta === FALSE) {
                                                        echo "Consulta falhou, parar aqui ";
                                                        die(mysqli_error());
                                                    }
                                                    //echo "<h4><br>PRINCIPAIS CLIENTES:</h4><br>";                   
                                                while($exibe = mysqli_fetch_assoc($consulta)):
                                                    //echo "<br><a href='#'>Editar</a>";
                                                    //echo utf8_encode($exibe["eCnpj"]). " - ";
                                                    echo utf8_encode($exibe["name"]). " - "; 
                                                    echo utf8_encode($exibe["eEndereco"]). " - "; 
                                                    echo utf8_encode($exibe["eTelefone1"]); 
                                                    echo "<br>";
